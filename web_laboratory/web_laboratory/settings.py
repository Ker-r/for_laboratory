"""
Django settings for web_laboratory project.
...
SECRET_KEY = '_s8f$h&)7xdc$yh_yaowt@%=om%5%u$cmt$v_=4f2v-unnb63^'
...
ROOT_URLCONF = 'web_laboratory.urls'
...
WSGI_APPLICATION = 'web_laboratory.wsgi.application'
